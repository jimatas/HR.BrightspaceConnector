...
namespace HR.BrightspaceConnector.Tests
{
    ...
    public class ProcessOrgUnitsTests : DependencyInjectedTestsBase
    {
        ...
        {
            // Arrange
            mockedDatabase.Setup(database => database.GetNextOrgUnitAsync(default)).ReturnsAsync(null as OrgUnitRecord);
            ...
            // Assert
            mockedDatabase.Verify(database => database.GetNextOrgUnitAsync(It.IsAny<CancellationToken>()), Times.Once());
        ...
        public async Task GivenOrgUnitToCreate_CreatesOrgUnit()
        {
            ...
            mockedDatabase.Setup(database => database.GetNextOrgUnitAsync(default)).ReturnsAsync(orgUnitRecord);
        ...
        {
            // Arrange
            mockedDatabase.Setup(database => database.GetNextOrgUnitAsync(default)).ReturnsAsync(new OrgUnitRecord
            {
                Code = "HR-FIT",
                Name = "Dienst FIT",
                Parents = new[] { RootOrgId },
